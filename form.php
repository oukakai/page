...
$require = array('お名前','Email','第一希望日','開始時間第一','第二希望日','開始時間第二','第三希望日','開始時間第三','プレイ時間','プレイ場所');
...
<?php }else{ ?>
<h3>確認画面</h3>
<p align="center">以下の内容で間違いがなければ、「送信する」ボタンを押してください。<br>いま一度、メールアドレスが正しいことをご確認ください。</p>
